      ...
      <article class="chapter-shell chapter-05">
        <header class="chapter-header">
          ...
          <p>
            ...
            Alles, was später zu Kapitel 5 gehört, bleibt in
            <strong>chapters/chapter-05.js</strong> und
            <strong>styles/chapter-05.css</strong>.
          </p>
        </header>

        <div class="chapter-placeholder">
          <div class="chapter-placeholder-icon">🧩</div>
          <h3>Kapitel 5 wartet auf sein Rätsel</h3>
          <p>
        ...
        ${ctx.debug ? `
          <div class="debug-controls">
            ...
            <button class="ghost-button" data-debug-next type="button">
              Kapitel 6 testweise freischalten
            </button>
          </div>
        ` : ""}
      </article>
