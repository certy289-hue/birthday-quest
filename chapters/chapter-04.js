      ...
      <article class="chapter-shell chapter-04">
        <header class="chapter-header">
          ...
          <p>
            ...
            Alles, was später zu Kapitel 4 gehört, bleibt in
            <strong>chapters/chapter-04.js</strong> und
            <strong>styles/chapter-04.css</strong>.
          </p>
        </header>

        <div class="chapter-placeholder">
          <div class="chapter-placeholder-icon">🧩</div>
          <h3>Kapitel 4 wartet auf sein Rätsel</h3>
          <p>
        ...
        ${ctx.debug ? `
          <div class="debug-controls">
            ...
            <button class="ghost-button" data-debug-next type="button">
              Kapitel 5 testweise freischalten
            </button>
          </div>
        ` : ""}
      </article>
